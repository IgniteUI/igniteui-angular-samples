...
@Component({
    ...
    selector:  "app-using-worksheets.component",
    styleUrls:  ["./using-worksheets.component.scss"],
    templateUrl: "./using-worksheets.component.html"
})
export class ExcelLibUsingWorksheetsComponent implements AfterViewInit {
