...
@Component({
    ...
    selector: "app-excel-working-with-grid.component",
    styleUrls: ["./excel-working-with-grid.component.scss"],
    templateUrl: "./excel-working-with-grid.component.html"
})

export class ExcelLibraryWorkingWithGridComponent implements OnInit {
