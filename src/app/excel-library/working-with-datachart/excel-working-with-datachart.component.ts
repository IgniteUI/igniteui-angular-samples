...
@Component({
    ...
    selector: "app-excel-working-with-datachart.component",
    styleUrls: ["./excel-working-with-datachart.component.scss"],
    templateUrl: "./excel-working-with-datachart.component.html"
})

export class ExcelLibraryWorkingWithDataChartComponent implements OnInit {
