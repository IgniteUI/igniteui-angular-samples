...
@Component({
    ...
    selector:  "app-excel-using-cells.component",
    styleUrls:  ["./excel-using-cells.component.scss"],
    templateUrl: "./excel-using-cells.component.html"
})

export class ExcelLibraryUsingCellsComponent implements OnInit {
