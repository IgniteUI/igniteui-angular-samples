export const notificationsRoutesData = {
    "banner-sample-1": { displayName: "Basic Banner", parentName: "Banner" },
    ...
    "banner-advanced-sample": { displayName: "Advanced Banner", parentName: "Banner" },
