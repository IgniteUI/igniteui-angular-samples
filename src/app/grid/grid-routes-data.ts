...
export const gridsRoutesData = {
    ...
    "grid-external-excel-style-filtering": { displayName: "External Excel Style Filtering", parentName: "Grid" },
    "grid-external-advanced-filtering": { displayName: "External Advanced Filtering", parentName: "Grid" },
