...
export class GridDragToGridSampleComponent {
    public data1: any[];
    public data2: any[];
    @ViewChild("dragGrid", { read: IgxGridComponent }) public sourceGrid: IgxGridComponent;
    @ViewChild("dropGrid", { read: IgxGridComponent }) public targetGrid: IgxGridComponent;
