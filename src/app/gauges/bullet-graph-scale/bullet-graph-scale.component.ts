...
export class BulletGraphScaleComponent implements AfterViewInit {
    ...
    public ngAfterViewInit(): void {
        ...
        this.bulletGraph.scaleBackgroundBrush = "DodgerBlue";
        this.bulletGraph.scaleBackgroundOutline = "DarkViolet";
        this.bulletGraph.scaleBackgroundThickness = 2;
