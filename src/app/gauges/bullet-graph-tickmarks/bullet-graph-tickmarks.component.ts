...
export class BulletGraphTickmarksComponent implements AfterViewInit {
    ...
    public ngAfterViewInit(): void {
        ...
        this.bulletGraph.tickBrush = "DodgerBlue";
        this.bulletGraph.ticksPreTerminal = 0;
        this.bulletGraph.ticksPostInitial = 0;
        this.bulletGraph.tickStrokeThickness = 2;
        this.bulletGraph.tickStartExtent = 0.2;
        this.bulletGraph.tickEndExtent = 0.075;

        // settings for minor tick marks
        this.bulletGraph.minorTickCount = 4;
        this.bulletGraph.minorTickBrush = "DarkViolet";
        ...
        this.bulletGraph.backingBrush = "white";
        this.bulletGraph.backingOutline = "#bfbfbf";
        this.bulletGraph.labelExtent = 0.05;
    }
