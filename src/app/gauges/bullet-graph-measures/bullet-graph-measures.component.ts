...
export class BulletGraphMeasuresComponent implements AfterViewInit {
    ...
    public ngAfterViewInit(): void {
        ...
        this.bulletGraph.value = 50;
        this.bulletGraph.valueBrush = "DodgerBlue";
        this.bulletGraph.valueStrokeThickness = 1;
        this.bulletGraph.valueInnerExtent = 0.5;
        this.bulletGraph.valueOuterExtent = 0.65;

        this.bulletGraph.targetValue = 80;
        this.bulletGraph.targetValueBreadth = 10;
        this.bulletGraph.targetValueBrush = "LimeGreen";
        this.bulletGraph.targetValueOutline = "LimeGreen";
        this.bulletGraph.targetValueStrokeThickness = 1;
        this.bulletGraph.targetValueInnerExtent = 0.3;
        this.bulletGraph.targetValueOuterExtent = 0.85;
