...
export class BulletGraphBackgroundComponent implements AfterViewInit {
    ...
    public ngAfterViewInit(): void {
        ...
        this.bulletGraph.backingBrush = "#bddcfc";
        this.bulletGraph.backingOutline = "DodgerBlue";
        this.bulletGraph.backingStrokeThickness = 4;
        this.bulletGraph.backingInnerExtent = 0;
        this.bulletGraph.backingOuterExtent = 1;

        this.bulletGraph.scaleBackgroundBrush = "white";
        this.bulletGraph.scaleBackgroundOutline = "white";
