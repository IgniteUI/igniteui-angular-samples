...
export const hierarchicalGridRoutesData = {
    ...
    "hierarchical-grid-external-excel-style-filtering": { displayName: "External Excel Style Filtering", parentName: "Hierarchical Grid" },
    "hierarchical-grid-external-advanced-filtering": { displayName: "External Advanced Filtering", parentName: "Hierarchical Grid" },
