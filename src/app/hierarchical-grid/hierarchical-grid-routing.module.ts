...
import { HierarchicalGridActionStripSampleComponent } from './hierarchical-grid-action-strip/hierarchical-grid-action-strip-sample';
...
export const hierarchicalGridRoutes: Routes = [
    ...
    {
        component: HierarchicalGridActionStripSampleComponent,
        data: hierarchicalGridRoutesData['hierarchical-grid-action-strip'],
