...
@NgModule({
  declarations: [MapTypeScatterSymbolSeriesComponent, MapBindingDataCsvComponent, MapBindingDataJsonPointsComponent, MapBindingDataModelComponent, MapBindingMultipleShapesComponent, MapBindingMultipleSourcesComponent, MapBindingShapefilePointsComponent, MapBindingShapefilePolygonsComponent, MapBindingShapefilePolylinesComponent, MapCustomTooltipsComponent, MapOverviewComponent, MapTypeScatterAreaSeriesComponent, MapTypeScatterBubbleSeriesComponent, MapTypeScatterContourSeriesComponent, MapTypeScatterDensitySeriesComponent, MapTypeShapePolygonSeriesComponent, MapTypeShapePolylineSeriesComponent],
  imports: [
    CommonModule,
    FormsModule,
