...
export const geoMapRoutesData = {
    ...
    "geo-map-binding-shapefile-polygons": { displayName: "Binding Shapefile Polygons", parentName: "Geo Map" },
    "geo-map-binding-shapefile-polylines": { displayName: "Binding Shapefile Polylines", parentName: "Geo Map" },
    "geo-map-binding-shapefile-points": { displayName: "Binding Shapefile Points", parentName: "Geo Map" },
