...
export const dataEntriesRoutesData = {
    ...
    "button-group-layout-sample": { displayName: "Button Group Overview", parentName: "Button Group" },
    "button-group-alignment-sample": { displayName: "Vertical Button Group", parentName: "Button Group" },
    "button-group-toggle-sample": { displayName: "Toggle Button Group", parentName: "Button Group" },
    "button-group-selection-sample": { displayName: "Selection Mode", parentName: "Button Group" },
    "button-group-size-sample": { displayName: "Display Density", parentName: "Button Group" },
    "button-group-style-sample": { displayName: "Button Group Style", parentName: "Button Group" },
    "button-group-tailwind-style-sample": { displayName: "Button Group Tailwind Style", parentName: "Button Group" },
