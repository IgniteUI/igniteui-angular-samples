...
export class TreeGridBatchEditingSampleComponent implements OnInit {
    ...
    public ngOnInit(): void {
        this.data = [
            ...
            { Salary: 2500, employeeID: 1, PID: -1, firstName: "Andrew", lastName: "Fuller", Title: "Vice President, Sales" },
            ...
            // sub of ID 19
            { Salary: 2500, employeeID: 20, PID: 19, firstName: "Declan", lastName: "Lester", Title: "Senior Software Developer" },
