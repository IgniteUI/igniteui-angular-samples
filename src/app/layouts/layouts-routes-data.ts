...
export const layoutsRoutesData = {
    ...
    'stepper-label-position-and-orientation-sample': { displayName: 'Stepper 1', parentName: 'Stepper' },
    'stepper-linear-sample': { displayName: 'Stepper 2', parentName: 'Stepper' },
    'stepper-stepstypes-sample': { displayName: 'Stepper 3', parentName: 'Stepper' },
    'stepper-styling-sample': { displayName: 'Stepper 4', parentName: 'Stepper' },
