...
import { TreeGridFinJSComponent } from "../../projects/app-dv/src/app/treegrid-finjs/tree-grid-finjs-sample.component";
import { TreeGridGroupingPipe } from "../../projects/app-dv/src/app/treegrid-finjs/tree-grid-grouping.pipe";
    ...
    public generateConfigs(): Config[] {
        ...
        configs.push(new Config({
            additionalFiles: ["/projects/app-dv/src/app/grid-finjs/localData.service.ts",
                ...
                "/projects/app-dv/src/app/treegrid-finjs/tree-grid-grouping.pipe.ts"],
