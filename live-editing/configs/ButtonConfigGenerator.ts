...
import {ButtonsDisplayDensityComponent} from "../../src/app/data-entries/buttons/buttons-display-density/buttons-display-density.component";
...
export class ButtonConfigGenerator implements IConfigGenerator {
    public generateConfigs(): Config[] {
        ...
        configs.push(new Config({
            ...
            appModuleConfig: new AppModuleConfig({
                imports: [IgxButtonModule, IgxIconModule, IgxRippleModule, IgxButtonGroupModule, ButtonsDisplayDensityComponent],
